                    ...
                    <table
                      ...
                      <tr style="border-collapse:collapse">
                        <td
                          ...
                          height="0">
                            <img
                              src="https://ytsycb.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                ...
                <tr style="border-collapse:collapse">
                  <td
                    ...
                    <table
                      ...
                      <tr style="border-collapse:collapse">
                        <td
                          style="padding:0;Margin:0;background-color:#08082c"
                          bgcolor="#08082C"
                          align="center">
                          <table
                            ...
                            align="center"
                            bgcolor="#08082C"
                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#08082c;width:600px">
                            <tr style="border-collapse:collapse">
                              <td
                                align="left"
                                  ...
                                  <tr style="border-collapse:collapse">
                                    <td
                                      ...
                                      <table
                                        ...
                                        cellpadding="0"
                                        bgcolor="#08082c"
                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#08082c"
                                        role="presentation">
                                        <tr style="border-collapse:collapse">
                                          <td
                                            align="center"
                                            ...
                                            <a
                                              ...
                                              style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#111111;font-size:14px">
                                              <img
                                                src="https://ytsycb.stripocdn.email/content/guids/CABINET_e80449d9bb655f6445dd4c8aea0a70f6/images/logo.png"
                                                alt
                                      ...
                                      <table
                                        ...
                                        <tr style="border-collapse:collapse">
                                          <td
                                            ...
                                            align="center"
                                            bgcolor="#0A1641"
                                            style="Margin:0;padding-left:30px;padding-right:30px;padding-top:35px;padding-bottom:35px">
                                            <h1
                                              style="Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#ffffff">
                                          ...
                                          <td
                                            ...
                                            <table
                                              ...
                                              <tr
                                                style="border-collapse:collapse">
                                                <td
                                                  style="padding:0;Margin:0;border-bottom:0px solid #ffffff;background:none 0% 0% repeat scroll #FFFFFF;height:1px;width:100%;margin:0px"></td>
                                              </tr>
                                            </table>
                                          </td>
                                        </tr>
                          ...
                          <table
                                      ...
                                      <table
                                        ...
                                        <tr style="border-collapse:collapse">
                                          <td
                                            ...
                                            <p
                                              style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#cccccc;font-size:18px">
                            ...
                            <tr style="border-collapse:collapse">
                              <td
                                align="left"
                                bgcolor="#0A1641"
                                style="padding:0;Margin:0;padding-bottom:20px;padding-left:30px;padding-right:30px;background-color:#0a1641">
                                <table
                                  width="100%"
                                  cellspacing="0"
                                  cellpadding="0"
                                        ...
                                        <tr style="border-collapse:collapse">
                                          <td
                                            ...
                                            <span
                                              ...
                                              <a
                                                href="${process.env.FRONT_URL}/recover-my-password/${idToRecoverPassword.id}"
                                                class="es-button"
                                                target="_blank"
                          ...
                          <table
                            ...
                            <tr style="border-collapse:collapse">
                              <td
                                align="left"
                                bgcolor="#08082c"
                                style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;background-color:#08082c">
                                <table
                                  cellpadding="0"
                                  cellspacing="0"
                                  width="100%"
